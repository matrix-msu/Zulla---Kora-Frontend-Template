...
if (images.length > 1) {
    ...
    for (var i = 0; i < images.length; i++){
        $('<li class="thumbnail"><div class="overlay-border"></div><img class="thumbnail-img" src="' + BASE_TEMPLATE_IMAGE_URL + images[i] + '" alt="' + i + '"></li>').appendTo("ul.slider");
    }
...
if (images) {
    ...
    window.document.getElementById('carousel-img').src = '' + BASE_TEMPLATE_IMAGE_URL + images[0] + ''
    window.document.getElementById('carousel-controls').children[0].href = '' + BASE_TEMPLATE_IMAGE_URL + images[0] + ''
    window.document.getElementById('carousel-controls').children[1].href = '' + BASE_TEMPLATE_IMAGE_URL + images[0] + ''
    window.document.getElementById('modal-image').src = '' + BASE_TEMPLATE_IMAGE_URL + images[0] + ''
...
function setImage () {
    ...
    window.document.getElementById('carousel-img').src = '' + BASE_TEMPLATE_IMAGE_URL + images[cur] + '';
    window.document.getElementById('modal-image').src = '' + BASE_TEMPLATE_IMAGE_URL + images[cur] + '';
