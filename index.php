    ...
    <?php
        ...
        if( file_exists($path) ) {
            ...
            if (isset($contents['theme']) && $contents['theme'] !== '') {
                echo '<link rel="stylesheet" href="' . BASE_URL . 'assets/scss/themes/' . $contents['theme'] . '.css" type="text/css">';
            }
        }
    ?>
...
<body>
<?php
    include BASE_VIEW_PATH . 'header.php';
    include BASE_VIEW_PATH . CURRENT_VIEW;
    include BASE_VIEW_PATH . 'footer.php';
?>
